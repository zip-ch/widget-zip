function zipWidget(arg) {
	...
	css    += '.zipWidgetLink{font-size:10px; font-family: "roboto", sans-serif; color: #6b6464; text-align: right; text-decoration: none; font-style: italic; display:block; margin-top:-5px;} .zipWidgetLinks{font-family: "roboto", sans-serif; list-style: none; margin: 10px 0 0; padding: 0; text-align: center; } .zipWidgetLogo img{height: auto; max-width: 70px; } .zipWidgetLinks li{display: inline-block; margin-right: 20px; } .zipWidgetLinks li:last-child{margin-right: 0px; } .zipWidgetLinks li a{text-decoration: none; color: '+textColor+'; } .zipWidgetLinks li a:hover{text-decoration:underline} #zipWidget{background: '+backgroundWidget+'; border-radius: '+radius+'; width: '+width+'; } .zipWidgetWrapper{padding: 15px; text-align: center; } .zipWidgetLogo{display: block; } .zipWidgetForm{margin-bottom: 0; overflow:hidden} .zipWidgetLabel{color: '+textColor+'; font-family: "Roboto", sans-serif; display:  block; font-size: 14px; margin: 15px 0 5px; font-weight: 300; } .zipWidgetInput{width:  100%; display:  block; position: relative; } .zipWidgetText{background: #fff; height: 36px; border-radius: 18px; font-size: 14px; border: none; padding: 0px 20px; width:  100%; border: '+border+'; } .zipWidgetText:focus{outline: none; } .zipWidgetSubmit{position: absolute; right: 3px; top: 3px; height: 30px; width: 30px; border-radius: 100%; background: #514b4b; color: #fff; box-shadow: 0 0 1px rgba(0,0,0,0.3); border:none; outline: none; display: block; } .zipWidgetSubmit:hover{background:#c3bebe; cursor: pointer; }';
